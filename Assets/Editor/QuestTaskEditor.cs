...
public class QuestTaskEditor : Editor
{
	...
	{
		Debug.Log("Executed");
		ShowOnEnum("Type", "Progressable", "CurrentProgress"); //type1Var is only visible when type == Type1
		ShowOnEnum("Type", "Progressable", "RequiredProgress"); //type2Var is only visible when type == Type2
